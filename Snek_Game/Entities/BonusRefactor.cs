...
{
    internal abstract class BonusRefactor
    {
    ...
    internal class B_Invincible : BonusRefactor
    {
        public B_Invincible()
        {
        }
    ...
    internal class B_DoubleFood : BonusRefactor
    {
        public B_DoubleFood()
        {
        }
    ...
    internal class B_Slow : BonusRefactor
    {
        public B_Slow()
        {
        }
    ...
    internal class B_Speedy : BonusRefactor
    {
        public B_Speedy()
        {
        }
    ...
    internal class B_Bullets : BonusRefactor
    {
        public B_Bullets()
        {
        }
